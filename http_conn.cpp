...
/*网站的根目录*/
const char* doc_root = "/home/code/c/linux_high_perf";
...
http_conn::HTTP_CODE http_conn::parse_request_line(char* text)
{
    ...
    *m_url++ = '\0';
    ...
    m_url += strspn(m_url, WHITESPACE);
    m_version = strpbrk(m_url, WHITESPACE);
    if (!m_version)
    {
        return BAD_REQUEST;
    }
    *m_version++ = '\0';
    m_version += strspn(m_version, WHITESPACE);
